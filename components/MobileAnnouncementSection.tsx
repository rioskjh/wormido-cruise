  ...
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
        {/* 공지사항 아이콘 - 모바일 버전 */}
        <div className="h-[30px] overflow-clip relative shrink-0 w-[30px]">
          ...
          <div className="absolute bottom-[4.4%] contents left-[28.91%] right-0 top-[-0.01%]">
            ...
            <div className="absolute contents inset-[33.06%_17.24%_29.16%_36.54%]">
              <div className="absolute contents inset-[33.06%_18.95%_29.16%_36.54%]">
      ...
      <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
        {/* 공지사항 목록 - 모바일 버전 */}
        <div className="box-border content-stretch flex flex-col gap-[2px] items-start pb-[10px] pt-0 px-0 relative shrink-0 w-full">
